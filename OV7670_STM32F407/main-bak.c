...
int main(void)
{
  ...
  unsigned char bmp[IMAGE_SIZE] = {0x01, 0x01, 0x01};
...
//        binary_simple(image_ori, image_bin);
        ...
        //  for (i = 0; i < 28; i++)
        //  {
        //    sprintf((char*) hex_display, "%2x, ", bmp[i]);
        //    HAL_UART_Transmit(&huart2, (uint8_t *) hex_display,
        //                      strlen((const char*) hex_display), 10);
        //  }
